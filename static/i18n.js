...
const I18N = (() => {
  ...
  const STRINGS = {
    ...
    'nav.logs':           { ar: '📊 سجل الطلبات',             en: '📊 Request log' },
    ...
    'api.pyTimeout':      { ar: 'مهلة طويلة: تحميل النموذج البارد قد يستغرق دقائق',
                            en: 'A long timeout: a cold model load can take minutes' },
    'api.pyDownload':     { ar: 'الملف الصوتي نفسه يُجلب من /audio بعد الاستجابة',
                            en: 'The wav itself is fetched from /audio after the response' },
    ...
    'ep.logs.hours':      { ar: '٠ = كل ما هو محفوظ', en: '0 = everything retained' },
    'ep.logs.route':      { ar: 'قالب المسار، مثل ‎/api/{model}/synthesize', en: 'Route template, e.g. /api/{model}/synthesize' },
    'ep.logs.status':     { ar: 'ok أو error أو رمز HTTP', en: 'ok, error, or an HTTP code' },
    'ep.logs.q':          { ar: 'بحث نصي في المسار والمدخلات والمخرجات', en: 'Free-text search over path, input and output' },
    'ep.logstats.title':  { ar: 'إحصاءات الاستخدام', en: 'Usage statistics' },
    'ep.logstats.desc':   { ar: 'إجماليات المدة المطلوبة وأزمنة الاستجابة وتفصيل حسب نقطة النهاية وخط زمني للطلبات.',
                            en: 'Totals for the window, response-time percentiles, a per-endpoint breakdown and a request timeline.' },
    'ep.logstats.buckets': { ar: 'عدد فترات الخط الزمني', en: 'Number of timeline buckets' },
    'ep.logone.title':    { ar: 'طلب واحد بالتفصيل', en: 'One logged request' },
    'ep.logone.desc':     { ar: 'السجل الكامل لطلب واحد عبر معرّفه.', en: 'The full record for a single request, by id.' },
    'ep.logclear.title':  { ar: 'مسح السجل', en: 'Clear the log' },
    'ep.logclear.desc':   { ar: 'يحذف كل الطلبات المسجَّلة. لا يمكن التراجع — لذلك لا يوجد زر تجربة هنا.',
                            en: 'Deletes every recorded request. Irreversible, which is why there is no try-it button here.' },
    ...
    'logs.intro': {
      ar: 'كل نداء على ‎/api/‎ يُسجَّل هنا: ما أُرسل، وما رجع، وكم استغرق. نداءات فحص الحالة الدورية مستثناة، والملفات المرفوعة تُسجَّل باسمها وحجمها فقط — لا يُحفظ محتواها.',
      en: 'Every /api/ call lands here: what went in, what came back, and how long it took. The UI’s periodic status polls are excluded, and uploaded files are recorded by name and size only — never their contents.',
    },
    'logs.window':        { ar: 'المدة', en: 'Window' },
    'logs.win1h':         { ar: 'ساعة',   en: '1 h' },
    'logs.win24h':        { ar: '٢٤ ساعة', en: '24 h' },
    'logs.win7d':         { ar: '٧ أيام',  en: '7 d' },
    'logs.winAll':        { ar: 'الكل',   en: 'All' },
    'logs.refresh':       { ar: '↻ تحديث', en: '↻ Refresh' },
    'logs.auto':          { ar: 'تحديث تلقائي', en: 'Auto-refresh' },
    'logs.clear':         { ar: 'مسح السجل', en: 'Clear log' },
    'logs.confirmClear':  { ar: 'حذف كل الطلبات المسجَّلة؟ لا يمكن التراجع.', en: 'Delete every recorded request? This cannot be undone.' },
    'logs.cleared':       { ar: 'تم مسح {n} طلباً ✓', en: '{n} requests cleared ✓' },
    'logs.disabled':      { ar: 'تسجيل الطلبات معطَّل على الخادم (TTS_LOG_REQUESTS=0)', en: 'Request logging is disabled on the server (TTS_LOG_REQUESTS=0)' },
    'logs.failed':        { ar: 'تعذّر تحميل السجل', en: 'Could not load the log' },

    'logs.total':         { ar: 'الطلبات',    en: 'Requests' },
    'logs.errors':        { ar: 'الأخطاء',    en: 'Errors' },
    'logs.avg':           { ar: 'المتوسط',    en: 'Average' },
    'logs.p50':           { ar: 'الوسيط',     en: 'Median' },
    'logs.p95':           { ar: 'الشريحة ٩٥', en: 'p95' },
    'logs.max':           { ar: 'الأبطأ',     en: 'Slowest' },
    'logs.traffic':       { ar: 'البيانات (وارد/صادر)', en: 'Data (in / out)' },
    'logs.stored':        { ar: 'محفوظ: {n} طلباً (حد الاحتفاظ {cap})', en: 'Stored: {n} requests (retention cap {cap})' },

    'logs.timeline':      { ar: 'الطلبات عبر الزمن', en: 'Requests over time' },
    'logs.endpoints':     { ar: 'حسب نقطة النهاية', en: 'By endpoint' },
    'logs.requests':      { ar: 'الطلبات', en: 'Requests' },
    'logs.col.endpoint':  { ar: 'نقطة النهاية', en: 'Endpoint' },
    'logs.col.count':     { ar: 'العدد',  en: 'Calls' },
    'logs.col.errors':    { ar: 'أخطاء',  en: 'Errors' },
    'logs.col.avg':       { ar: 'متوسط',  en: 'Avg' },
    'logs.col.p95':       { ar: 'p95',    en: 'p95' },
    'logs.col.last':      { ar: 'آخر نداء', en: 'Last call' },
    'logs.col.time':      { ar: 'الوقت',  en: 'Time' },
    'logs.col.status':    { ar: 'الحالة', en: 'Status' },
    'logs.col.took':      { ar: 'المدة',  en: 'Took' },

    'logs.allRoutes':     { ar: 'كل نقاط النهاية', en: 'All endpoints' },
    'logs.statusAll':     { ar: 'كل الحالات', en: 'Any status' },
    'logs.statusOk':      { ar: 'ناجحة فقط', en: 'Successful only' },
    'logs.statusErr':     { ar: 'أخطاء فقط', en: 'Errors only' },
    'logs.searchPh':      { ar: 'بحث في المسار أو المدخلات أو المخرجات…', en: 'Search path, input or output…' },
    'logs.empty':         { ar: 'لا توجد طلبات مطابقة في هذه المدة', en: 'No matching requests in this window' },
    'logs.loading':       { ar: 'جاري التحميل…', en: 'Loading…' },
    'logs.loadMore':      { ar: 'تحميل المزيد ({n})', en: 'Load more ({n})' },
    'logs.showing':       { ar: 'يعرض {shown} من {total}', en: 'Showing {shown} of {total}' },

    'logs.input':         { ar: 'المُدخَل', en: 'Input' },
    'logs.output':        { ar: 'المُخرَج', en: 'Output' },
    'logs.errorLabel':    { ar: 'الخطأ',   en: 'Error' },
    'logs.client':        { ar: 'العميل',  en: 'Client' },
    'logs.agent':         { ar: 'المتصفح/الأداة', en: 'User agent' },
